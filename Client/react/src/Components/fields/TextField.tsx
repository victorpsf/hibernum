...
const TextField = function ({ label, value, onTextChange }: ITextFieldProps): JSX.Element {
    ...
    const handleOnTextChange = function (_value?: string): void {
        onTextChange(_value || undefined);
    }
    ...
    return (
        <div className={'relative w-full'}>
            ...
            <input
                className={'rounded border border-gray-400 w-full p-4 text-base outline-0'}
                value={value}
